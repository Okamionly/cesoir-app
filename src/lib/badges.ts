...
export const ALL_BADGES: Badge[] = [
  ...
  // ── Explorer (6) ──
  {
    ...
    name: "Globe-Trotter",
    emoji: "🌍",
    description: "Essaie les 14 modes",
    category: "explorer",
    requirement: "Activer chacun des 14 modes au moins une fois",
    rarity: "epic",
    xp: 300,
  },
  {
  ...
  },
  {
    ...
    name: "Routard",
    emoji: "🗺️",
    description: "Visite 10 arrondissements differents",
    category: "explorer",
    requirement: "Check-in dans 10 arrondissements",
    rarity: "epic",
    xp: 250,
  },
  {
