      ...
      {step === "camera" && (
        ...
        >
          ...
          <motion.div
            ...
            animate={{
              borderColor: ["rgba(139,92,246,0.3)", "rgba(0,255,136,0.3)", "rgba(139,92,246,0.3)"],
            }}
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <motion.div
                ...
                animate={{
                  borderColor: ["rgba(139,92,246,0.4)", "rgba(0,255,136,0.4)", "rgba(139,92,246,0.4)"],
                  scale: [1, 1.02, 1],
                }}
          ...
          >
            ...
            {[...Array(8)].map((_, i) => (
              <motion.div
                key={i}
                className="absolute w-2 h-2 rounded-full"
                style={{ background: i % 2 === 0 ? "#3B82F6" : "#00FF88" }}
                initial={{ x: 0, y: 0, opacity: 1, scale: 1 }}
                animate={{
                  x: Math.cos((i / 8) * Math.PI * 2) * 60,
                  y: Math.sin((i / 8) * Math.PI * 2) * 60,
      ...
      <div className="space-y-3">
        ...
        >
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: "linear-gradient(45deg, #f09433, #e6683c, #dc2743, #cc2366, #bc1888)" }}>
